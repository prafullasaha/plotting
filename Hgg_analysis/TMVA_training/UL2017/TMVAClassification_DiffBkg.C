...
int TMVAClassification_DiffBkg( TString myMethodList = "" )
{
...
//     TString fname = "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_THQ_ctcvcp_HToGG_M125_TuneCP5_13TeV-madgraph-pythia8_ctm1cv1.root";
    TString fname = "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8_SM_woPU.root";

   if (!gSystem->AccessPathName( fname )) {
    input = TFile::Open( fname ); // check if file in local directory exists
//    input1 = TFile::Open("output_TTGG_0Jets_TTGJets.root");
//    input_tth = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root");
    input_ttgg = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8_woPU.root");
    input_ttgjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_woPU.root");
    
    input_DiPhotonJetsBox = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa_woPU.root");
    input_DiPhotonJetsBox2BJets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa_woPU.root");
/*    input_ttgg_16 = TFile::Open("output_TTGG_0Jets_TuneCUETP8M1_13TeV_amcatnlo_madspin_pythia8_16.root");
    input_ttgjets_16 = TFile::Open("output_TTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8_16.root");

    input_DiPhotonJetsBox_16 = TFile::Open("output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa_16.root");
    input_DiPhotonJetsBox2BJets_16 = TFile::Open("output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa_16.root");
    input_ttgg_17 = TFile::Open("output_TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8_17.root");
    input_ttgjets_17 = TFile::Open("output_TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_17.root");

    input_DiPhotonJetsBox_17 = TFile::Open("output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa_17.root");
    input_DiPhotonJetsBox2BJets_17 = TFile::Open("output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa_17.root");
    input_ttgg_18 = TFile::Open("output_TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8_18.root");
    input_ttgjets_18 = TFile::Open("output_TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_18.root");

    input_DiPhotonJetsBox_18 = TFile::Open("output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa_18.root");
    input_DiPhotonJetsBox2BJets_18 = TFile::Open("output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa_18.root");
*/
    input_gjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8_woPU.root");
...
//   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
   ...
   TTree *signalTree     = (TTree*)input->Get("tagsDumper/trees/thq_125_13TeV_THQLeptonicTag");
//   TTree *background     = (TTree*)input_tth->Get("tagsDumper/trees/tth_125_13TeV_THQLeptonicTag");

//   TTree *tree_tgjets     = (TTree*)input_tgjets->Get("tagsDumper/trees/tgjets_13TeV_THQLeptonicTag");
   TTree *tree_ttgg = (TTree*)input_ttgg->Get("tagsDumper/trees/ttgg_13TeV_THQLeptonicTag");
   TTree *tree_ttgjets = (TTree*)input_ttgjets->Get("tagsDumper/trees/ttgjets_13TeV_THQLeptonicTag");
   TTree *tree_DiPhotonJetsBox  = (TTree*)input_DiPhotonJetsBox->Get("tagsDumper/trees/DiPhotonJetsBox_13TeV_THQLeptonicTag");
   TTree *tree_gjets = (TTree*)input_gjets->Get("tagsDumper/trees/gjets_13TeV_THQLeptonicTag");
   TTree *tree_DiPhotonJetsBox2BJets  = (TTree*)input_DiPhotonJetsBox2BJets->Get("tagsDumper/trees/DiPhotonJetsBox2BJets_13TeV_THQLeptonicTag");
//   TTree *tree7     = (TTree*)input_tth->Get("tagsDumper/trees/tth_125_13TeV_THQLeptonicTag");
...
*/
/*
	list->Add(tree_ttgg_16);
	list->Add(tree_ttgjets_16);
	list->Add(tree_DiPhotonJetsBox_16);
	list->Add(tree_DiPhotonJetsBox2BJets_16);
	list->Add(tree_ttgg_17);
        list->Add(tree_ttgjets_17);
        list->Add(tree_DiPhotonJetsBox_17);
        list->Add(tree_DiPhotonJetsBox2BJets_17);
	list->Add(tree_ttgg_18);
        list->Add(tree_ttgjets_18);
        list->Add(tree_DiPhotonJetsBox_18);
        list->Add(tree_DiPhotonJetsBox2BJets_18);
*/
...
//   dataloader->AddBackgroundTree( background );
   dataloader->AddBackgroundTree(tree_ttgg);
//   dataloader->AddBackgroundTree(tree_tgjets);
   dataloader->AddBackgroundTree(tree_ttgjets);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox2BJets);
//   dataloader->AddBackgroundTree(tree_gjets);
...
//   dataloader->SetBackgroundWeightExpression( "weight" );
   ...
   TCut mycuts ="weight<0.001";//"bjet3_discr > -999 && bjet2_discr > -999 && bjet2_eta > -999 && jet2_eta > -999 && bjet2_pt > -999 && jet2_pt > -999"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb ="";//"bjet3_discr > -999 && bjet2_discr > -999 && bjet2_eta > -999 && jet2_eta > -999 && bjet2_pt > -999 && jet2_pt > -999"; // for example: TCut mycutb = "abs(var1)<0.5";
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_DiffBkg(methodList);
}
