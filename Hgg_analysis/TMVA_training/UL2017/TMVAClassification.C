...
//    input_tth = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root");
    input_tgjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_TGJets_TuneCP5_13TeV_amcatnlo_madspin_pythia8.root");
    input_ttgg = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8.root");
    input_ttgjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8.root");
    
    input_DiPhotonJetsBox = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa.root");
    input_DiPhotonJetsBox2BJets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa.root");
...
*/
    input_gjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8.root");
...
//   dataloader->SetBackgroundWeightExpression( "weight" );
   ...
   TCut mycuts ="weight<100";//"bjet3_discr > -999 && bjet2_discr > -999 && bjet2_eta > -999 && jet2_eta > -999 && bjet2_pt > -999 && jet2_pt > -999"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
