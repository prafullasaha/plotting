...
//   TString fname = "/home/prafulla/result_higheta/thq_tth_test_muon.root";
     TString fname = "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root";

   if (!gSystem->AccessPathName( fname )) {
    input = TFile::Open( fname ); // check if file in local directory exists
//    input1 = TFile::Open("output_TTGG_0Jets_TTGJets.root");
    input_tth = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root");
//    input_tgjets = TFile::Open("output_TGJets_TuneCUETP8M1_13TeV_amcatnlo_madspin_pythia8.root");
    input_ttgg = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_TTGG_0Jets_pythia8.root");
    input_ttgjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_TTGJets_pythia8.root");
    
    input_DiPhotonJetsBox = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root");
    input_DiPhotonJetsBox2BJets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root");
...
*/
    input_gjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root");
