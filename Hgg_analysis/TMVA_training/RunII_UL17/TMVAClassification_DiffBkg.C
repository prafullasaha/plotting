...
int TMVAClassification_DiffBkg( TString myMethodList = "", int year=2 )
{
   ...
   // --------------------------------------------------------------------------------------------------
   TMVA::DataLoader *dataloader=new TMVA::DataLoader(Form("dataset_Run%i_v1",year));
   ...
   TFile *input_ttgg;
   TFile *input_ttgjets;
   TFile *input_DiPhotonJetsBox;
   TFile *input_gjets;
   TFile *input_DiPhotonJetsBox2BJets;
...
if(run2016){
    ...
    input_thq_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016_ctCv_SM/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root");
    input_ttgg_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016_ctCv_SM/output_TTGG_0Jets_TuneCUETP8M1_13TeV_amcatnlo_madspin_pythia8.root");
//input_ttgg_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016/output_TTGG_0Jets_pythia8.root");
    input_ttgjets_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016_ctCv_SM/output_TTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8.root");
    input_DiPhotonJetsBox_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016_ctCv_SM/output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa.root");
    input_DiPhotonJetsBox2BJets_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016_ctCv_SM/output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa.root");
    input_gjets_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016_ctCv_SM/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCUETP8M1_13TeV_Pythia8.root");
   ...
   TTree *signalTree_16     = (TTree*)input_thq_16->Get("tagsDumper/trees/thq_125_13TeV_THQLeptonicTag");
   ...
   dataloader->AddSignalTree( signalTree_16 );
   dataloader->AddBackgroundTree(tree_ttgg_16);
   dataloader->AddBackgroundTree(tree_ttgjets_16);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox_16);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox2BJets_16);
   dataloader->AddBackgroundTree(tree_gjets_16);
   dataloader->AddBackgroundTree(tree_TGJets_16);
   dataloader->AddBackgroundTree(tree_TTJets_16);
   dataloader->AddBackgroundTree(tree_ZG_16);
   dataloader->AddBackgroundTree(tree_WG_16);
   dataloader->AddBackgroundTree(tree_TTWJets_16);
   dataloader->AddBackgroundTree(tree_DYJets_16);
   dataloader->AddBackgroundTree(tree_VH_16);
...
if(run2017){
    ...
    input_thq_17 = TFile::Open( "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8_SM.root" );
    input_ttgg_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8.root");
    input_ttgjets_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8.root");
    input_DiPhotonJetsBox_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa.root");
    input_DiPhotonJetsBox2BJets_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa.root");
    input_gjets_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/UL2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8.root");
   ...
   input_VH_17 = TFile::Open(file_path + "output_VHToGG_M125_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8.root");


   TTree *signalTree_17     = (TTree*)input_thq_17->Get("tagsDumper/trees/thq_125_13TeV_THQLeptonicTag");  
   ...
   dataloader->AddSignalTree( signalTree_17 );
   dataloader->AddBackgroundTree(tree_ttgg_17);
   dataloader->AddBackgroundTree(tree_ttgjets_17);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox_17);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox2BJets_17);
   dataloader->AddBackgroundTree(tree_gjets_17);
   dataloader->AddBackgroundTree(tree_TGJets_17);
   dataloader->AddBackgroundTree(tree_TTJets_17);
   dataloader->AddBackgroundTree(tree_ZG_17);
   dataloader->AddBackgroundTree(tree_WG_17);
   dataloader->AddBackgroundTree(tree_TTWJets_17);
   dataloader->AddBackgroundTree(tree_DYJets_17);
   dataloader->AddBackgroundTree(tree_VH_17);


   mycuts ="weight>0 && weight<0.001";
   mycutb ="weight>0";
   dataloader->SetSignalWeightExpression( "11.84*weight" );
}
//2018
if(run2018){
    file_path="/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/UL/2018/";
    input_thq_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018_ctCv_SM/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root");
    input_ttgg_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018_ctCv_SM/output_TTGG_0Jets_TuneCP5_13TeV_amcatnlo_madspin_pythia8.root");
    input_ttgjets_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018_ctCv_SM/output_TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8.root");
    input_DiPhotonJetsBox_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018_ctCv_SM/output_DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa.root");
    input_DiPhotonJetsBox2BJets_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018_ctCv_SM/output_DiPhotonJetsBox2BJets_MGG-80toInf_13TeV-Sherpa.root");
    input_gjets_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018_ctCv_SM/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8.root");
   ...
   TTree *signalTree_18     = (TTree*)input_thq_18->Get("tagsDumper/trees/thq_125_13TeV_THQLeptonicTag");  
   ...
   dataloader->AddSignalTree( signalTree_18 );
   dataloader->AddBackgroundTree(tree_ttgg_18);
   dataloader->AddBackgroundTree(tree_ttgjets_18);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox_18);
   dataloader->AddBackgroundTree(tree_DiPhotonJetsBox2BJets_18);
   dataloader->AddBackgroundTree(tree_gjets_18);
  dataloader->AddBackgroundTree(tree_TGJets_18);
   dataloader->AddBackgroundTree(tree_TTJets_18);
   dataloader->AddBackgroundTree(tree_ZG_18);
   dataloader->AddBackgroundTree(tree_WG_18);
   dataloader->AddBackgroundTree(tree_TTWJets_18);
   dataloader->AddBackgroundTree(tree_DYJets_18);
   dataloader->AddBackgroundTree(tree_VH_18);
...
//   TTree *background     = (TTree*)input1->Get("events_tth");
   ...
   TString outfileName( Form("TMVA_Run%iUL_v1.root", year) );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
