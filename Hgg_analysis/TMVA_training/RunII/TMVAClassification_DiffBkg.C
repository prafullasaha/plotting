...
int TMVAClassification_DiffBkg( TString myMethodList = "", int year=2 )
{
   ...
   // --------------------------------------------------------------------------------------------------
   TMVA::DataLoader *dataloader=new TMVA::DataLoader(Form("dataset_Run%i",year));
...
//2016
if(run2016){
    input_thq_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root");
...
//input_ttgg_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016/output_TTGG_0Jets_pythia8.root");
    input_ttgjets_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016/output_TTGJets_pythia8.root");
    input_DiPhotonJetsBox_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root");
    input_DiPhotonJetsBox2BJets_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root");
    input_gjets_16 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2016/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root");
...
//2017
if(run2017){
    input_thq_17 = TFile::Open( "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2017/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root" );
    input_ttgg_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2017/output_TTGG_0Jets_pythia8.root");
    input_ttgjets_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2017/output_TTGJets_pythia8.root");
    input_DiPhotonJetsBox_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2017/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root");
    input_DiPhotonJetsBox2BJets_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2017/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root");
    input_gjets_17 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root");
...
//2018
if(run2018){
    input_thq_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root");
    input_ttgg_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_TTGG_0Jets_pythia8.root");
    input_ttgjets_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_TTGJets_pythia8.root");
    input_DiPhotonJetsBox_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root");
    input_DiPhotonJetsBox2BJets_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root");
    input_gjets_18 = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/TMVA_training_inputs/2018/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root");
...
//   TTree *background     = (TTree*)input1->Get("events_tth");
   ...
   TString outfileName( Form("TMVA_Run%i.root", year) );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
