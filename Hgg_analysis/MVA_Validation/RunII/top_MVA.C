...
for(int i=0; i<file_size; i++)
	...
	hist[i]=new TH1F("MVA_score_Bkg"," ;m_{#gamma#gamma}",nbins,min_score,max_score);
		...
		hist[i]->Fill(qMVA1, scaleWeight*qweight);}
		else
		{
...
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/top_DNN_validation_RunII.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/top_DNN_validation_RunII.pdf");
}
