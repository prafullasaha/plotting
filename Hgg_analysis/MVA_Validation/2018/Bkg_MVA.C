...
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_validation_18.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_validation_18.pdf");
}
