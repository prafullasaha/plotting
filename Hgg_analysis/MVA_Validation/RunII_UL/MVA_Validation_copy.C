...
TLegend *leg1 = new TLegend(0.5, 0.6, 0.89, 0.87, "");
leg1->SetNColumns(2);
...
hist_tth->Scale(10);
	...
	TLatex * tex1 = new TLatex(0.10, 0.97,TString("#bf{CMS}"));
        tex1->SetNDC();
...
//        tex->Draw();
        ...
        TLatex * tex2 = new TLatex(0.66, 0.97,TString(Form("%.0f fb^{-1} (13 TeV)",lumi)));
        tex2->SetNDC();
...
*/
	...
	hRatio_stat_Err->SetStats(0);
        ...
        hRatio_stat_Err->GetYaxis()->SetLabelSize(0.11);
