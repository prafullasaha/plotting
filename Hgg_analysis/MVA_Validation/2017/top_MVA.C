...
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/top_DNN_validation_17.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/top_DNN_validation_17.pdf");
}
