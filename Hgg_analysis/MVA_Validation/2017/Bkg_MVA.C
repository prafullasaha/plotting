...
TString file[file_size] = {"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_TTGG_0Jets_pythia8.root", 
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_TTGJets_pythia8.root", 
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root", 
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/WW_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/WZ_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/ZZ_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/TTWJetsToLNu_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/ZGTo2LG_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/TTZToLLNuNu_M-10_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2016/tZq_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/DYJetsToLL_M-50_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root",
"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_validation_inputs/2017/output_Data_17.root"};
...
THStack *hs = new THStack("hs",";MVA_score");
...
for(int i=0; i<file_size; i++)
	...
	hist[i]=new TH1F("MVA_score_Bkg"," ;m_{#gamma#gamma}",nbins,min_score,max_score);
		...
		hist_Data->Fill(qMVA2, scaleWeight*qweight);
		}
		}
		else if(procs[i]=="thq_125")
		{
		hist_thq->Fill(qMVA2, scaleWeight*qweight);
		h2_thq->Fill(qMVA1, qMVA2, scaleWeight*qweight);
		}
		else if(procs[i]=="tth_125")
                {
		hist_tth->Fill(qMVA2, scaleWeight*qweight);
		h2_tth->Fill(qMVA1, qMVA2, scaleWeight*qweight);	
                }
		else
		{
		hist[i]->Fill(qMVA2, scaleWeight*qweight);
		...
		h2_bkg->Fill(qMVA1, qMVA2, scaleWeight*qweight);
		}
                }
		}
...
TBox* box =new TBox(min_score, 0,MVA2_cut, hist_Data->GetMaximum());
...
//        totalMC->Draw("E2 SAME");
        hs->SetMaximum(25*hist_Data->GetMaximum());
...
h2_bkg->Draw("colz");
*/
c1->SaveAs("plots/Bkg_BDT_validation.root");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_validation_17.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_validation_17.pdf");
}
