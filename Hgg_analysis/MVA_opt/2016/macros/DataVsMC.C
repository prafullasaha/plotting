...
TString file[file_size] = {"../output_TTGG_0Jets_pythia8.root", "../output_TTGJets_pythia8.root", "../output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root", "../output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root","../output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root","../output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8_16_bugFixed.root","../output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8_16_bugFixed.root","../allData_16.root"};
...
//box->SetLineColorAlpha(9, 0.571);
	...
	hRatio->GetYaxis()->SetLabelSize(0.09);
      	hRatio->GetYaxis()->SetTitle("#frac{#bf{Data}}{#bf{MC}}");
      	hRatio->GetXaxis()->SetTitle("#bf{top DNN}");
	...
	hRatio_stat_Err->SetStats(0);
        ...
        hRatio_stat_Err->GetXaxis()->SetTitle("#bf{top_DNN}");
