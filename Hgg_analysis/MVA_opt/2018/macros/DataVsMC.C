...
TString file[file_size] = {"../output_TTGG_0Jets_pythia8.root", "../output_TTGJets_pythia8.root", "../output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root", "../output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root","../output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root","../output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root","../output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root","../allData_18.root"};
...
TLine *l = new TLine(MVA2_cut,0,MVA2_cut,40);
l->SetLineWidth(3);
l->SetLineColor(13);
l->SetLineStyle(7);
...
leg1->Draw("SAME");
tex->Draw();
c1->SaveAs("plots/BDTscore_NonHiggs_18.root");
c3->cd();
c3->Divide(2,2);
c3->cd(1);
h2_thq->Draw("colz");
