...
TString file[file_size] = {"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_TTGG_0Jets_pythia8.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_TTGJets_pythia8.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_Data_17.root"};
...
TLegend *leg1 = new TLegend(0.3, 0.6, 0.6, 0.89, "");
...
for(int i=0; i<file_size; i++)
	...
	if(procs[i]=="Data"){leg2->AddEntry(hist_Data, procs_[i].c_str(),"ep"); }
...
//	hRatio_stat_Err->SetFillStyle(3001);
	hRatio_stat_Err->GetYaxis()->SetRangeUser(0,2);
	hRatio_stat_Err->SetFillColorAlpha(kRed, 0.35);

	totalMC->SetLineColor(kRed);
	totalMC->SetFillColorAlpha(kRed, 0.35);
...
pad1->cd();
	...
	hs->GetYaxis()->SetTitleOffset(1);
        ...
        hs->SetMaximum(20*hist_Data->GetMaximum());
...
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_Score_17.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_Score_17.pdf");
}
