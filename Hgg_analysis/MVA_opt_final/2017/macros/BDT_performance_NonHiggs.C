...
void BDT_performance_NonHiggs(){
	TFile *file_tth = new TFile("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root", "READ");
        TFile *file_thq = new TFile("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root", "READ");
	TFile *file_ttgg = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_TTGG_0Jets_pythia8.root");
        TFile *file_ttgjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_TTGJets_pythia8.root");
        TFile *file_DiPhotonJetsBox = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root");
        TFile *file_DiPhotonJetsBox2BJets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root");
	TFile *file_gjets = TFile::Open("/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2017/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root");
...
eff_l->Draw();
tex->Draw();
eff->SaveAs("plots/BDT_eff_NonHiggs_17.root");
sig->SaveAs("plots/BDT_sig_NonHiggs_17.root");
}
