...
cout<<"Running on 2016 samples"<<endl;
	file_path = "/eos/user/p/prsaha/Tprime_analysis/MVAOpt_inputs/2016/";
        file_tth = new TFile(file_path + "", "READ");
        file_thq = new TFile(file_path + "", "READ");
        file_ttgg = TFile::Open(file_path + "");
        file_ttgjets = TFile::Open(file_path + "");
        file_DiPhotonJetsBox = TFile::Open(file_path + "");
        file_DiPhotonJetsBox2BJets = TFile::Open(file_path + "");
        file_gjets = TFile::Open(file_path + "");
   	file_TTJets = TFile::Open(file_path + "");
   	file_TGJets = TFile::Open(file_path + "");
   	file_ZG = TFile::Open(file_path + "");
   	file_WG = TFile::Open(file_path + "");
   	file_TTWJets = TFile::Open(file_path + "");
   	file_DYJets = TFile::Open(file_path + "");
   	file_VH = TFile::Open(file_path + "");
