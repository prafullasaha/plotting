...
TString file[file_size] = {"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_TTGG_0Jets_pythia8.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_TTGJets_pythia8.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/2018/output_Data_18.root"};
...
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_Score_18.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/Bkg_BDT_Score_18.pdf");
}
