...
double MVA2_cut=0.07;//For non-Higgs bkg
int MVA_no = 1;
...
h2_bkg->Draw("colz");
*/
c1->SaveAs("plots/tHqTag_Bkg_MVA.root");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/tHqTag_Bkg_MVA.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/tHqTag_Bkg_MVA.pdf");
}
