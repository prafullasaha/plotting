...
TString file[file_size] = {"/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_TTGG_0Jets_pythia8.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_TTGJets_pythia8.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_DiPhotonJetsBox_MGG-80toInf_Sherpa.root", "/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_DiPhotonJetsBox2BJets_MGG-80toInf_Sherpa.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_THQ_ctcvcp_HToGG_M125_13TeV-madgraph-pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root","/eos/user/p/prsaha/Hgg_analysis_LRun2_NewPreSel/MVA_opt_inputs/RunII/output_Data_RunII.root"};
...
THStack *hs = new THStack("hs",";MVA_score;Events/(0.025)");
...
//box->SetLineColorAlpha(9, 0.571);
	...
	hRatio->GetYaxis()->SetLabelSize(0.09);
      	...
      	hRatio->GetXaxis()->SetTitle("top DNN");
...
pad1->cd();
        ...
        hs->Draw("hist");
	hs->GetYaxis()->SetTitle("Events/(0.025)");
...
h2_bkg->Draw("colz");
*/
c1->SaveAs("plots/top_MVA.root");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/tHqTag_top_MVA.png");
c1->SaveAs("/eos/user/p/prsaha/www/Hgg_analysis/Variable_plots/tHqTag_top_MVA.pdf");
}
