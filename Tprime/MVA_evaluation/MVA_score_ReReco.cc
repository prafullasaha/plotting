...
file.push_back("ZGTo2LG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root");
file.push_back("output_DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root");
file.push_back("output_WGToLNuG_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root");
...
file.push_back("output_VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root");
file.push_back("output_VBFHToGG_M-125_13TeV_powheg_pythia8.root");
file.push_back("output_GluGluHToGG_M125_13TeV_amcatnloFXFX_pythia8.root");
...
file.push_back("WGToLNuG_01J_5f_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
...
file.push_back("output_ttHJetToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root");
file.push_back("output_VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root");
file.push_back("output_VBFHToGG_M125_13TeV_amcatnlo_pythia8.root");
file.push_back("output_GluGluHToGG_M125_13TeV_amcatnloFXFX_pythia8.root");
file.push_back("output_TprimeBToTH_Hgg_M-600_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8.root");
file.push_back("output_TprimeBToTH_Hgg_M-625_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8.root");
file.push_back("output_TprimeBToTH_Hgg_M-650_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8.root");
...
file.push_back("output_VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root");
file.push_back("output_VBFHToGG_M125_13TeV_amcatnlo_pythia8.root");
file.push_back("output_GluGluHToGG_M125_TuneCP5_13TeV-amcatnloFXFX-pythia8.root");
file.push_back("output_TprimeBToTH_Hgg_M-600_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8.root");
file.push_back("output_TprimeBToTH_Hgg_M-625_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8.root");
file.push_back("output_TprimeBToTH_Hgg_M-650_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8.root");
file.push_back("output_TprimeBToTH_Hgg_M-675_LH_TuneCP5_PSweights_13TeV-madgraph_pythia8.root");
...
//file.push_back("output_DoubleEG_Run2016.root");
//file.push_back("alldata_ntuple_16G.root");

file_size = file.size();
xmlfile_TprimeVsNonHiggs 	="/afs/cern.ch/work/p/prsaha/public/plotting_macro/CMSSW_9_4_9/src/Tprime/Training/dataset_Run2_Tprime600_700VsHiggs/weights/TMVAClassification_BDTG.weights.xml";
//xmlfile_TprimeVsHiggs 		="/afs/cern.ch/work/p/prsaha/public/plotting_macro/CMSSW_9_4_9/src/Tprime/Training/dataset_Run2_Tprime600_700VsHiggs/weights/TMVAClassification_BDTG.weights.xml";
xmlfile_TprimeVsHiggs                 ="/afs/cern.ch/work/p/prsaha/public/Tprime_analysis/flashgg_legacy_runII_v4/CMSSW_10_6_8/src/flashgg/Taggers/data/Tprime_search_training/THQLeptonicTag_TprimeM1100_M1200Vs_HiggsBkg_BDTG_RunII.weights.xml";
}

string procs[file_size] 	= {"ttgg", "ttgjets","DiPhotonJetsBox","DiPhotonJetsBox2BJets","gjets","WW","WZ","ZZ","ttwjets","ZG","DYJets","WG","tgjets","ttjets","thq_125","tth_125","vh_125","vbf_125","ggh_125","Tprime_600","Tprime_625","Tprime_650","Tprime_675","Tprime_700","Tprime_800","Tprime_900","Tprime_1000","Tprime_1100","Tprime_1200","Data"};
string procs_outTree[file_size] = {"ttgg", "ttgjets","DiPhotonJetsBox","DiPhotonJetsBox2BJets","gjets","WW","WZ","ZZ","ttwjets","ZG","DYJets","WG","tgjets","ttjets","thq_125","tth_125","vh_125","vbf_125","ggh_125","Tprime_600","Tprime_625","Tprime_650","Tprime_675","Tprime_700","Tprime_800","Tprime_900","Tprime_1000","Tprime_1100","Tprime_1200","Data"};
ofstream myfile;
...
//output file----------------------------------------------------------------------------------------
	TFile *file_output = TFile::Open(Form("output_files/Run%i/output_%s.root",year, procs_outTree[i].c_str()), "RECREATE");
