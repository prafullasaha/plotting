...
float xsbr[] = {0.1764, 0.1489, 0.1213, 0.1050, 0.0886, 0.0459, 0.0251, 0.0145, 0.00867, 0.00536}; //for 1% width in pb

float xs_kT0p2[] = {0.1445, 0.1317, 0.1189, 0.1130, 0.1070, 0.0735, 0.0512, 0.0371, 0.0272, 0.0198}; //for kT=0.2 in pb
...
//cout<<"        "<<mass[i]<<"       "<<abs_eff[i]<<endl;
//cout<<"  - value: "<<abs_eff[i]<<endl;
cout<<abs_eff[i]*xs_kT0p2[i]*137*1000*0.00227<<","<<endl;
