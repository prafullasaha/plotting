...
/*file.push_back("output_TprimeM600.root");
file.push_back("output_TprimeM625.root");
file.push_back("output_TprimeM650.root");
file.push_back("output_TprimeM675.root");
file.push_back("output_TprimeM700.root");
file.push_back("output_TprimeM800.root");
file.push_back("output_TprimeM900.root");
file.push_back("output_TprimeM1000.root");
file.push_back("output_TprimeM1100.root");
file.push_back("output_TprimeM1200.root");
*/
...
string procs[file_size] = {"TprimeM600_125","TprimeM625_125","TprimeM650_125","TprimeM675_125","TprimeM700_125","TprimeM800_125","TprimeM900_125","TprimeM1000_125","TprimeM1100_125","TprimeM1200_125"};
...
file_path = Form("/eos/user/p/prsaha/Tprime_analysis/MVAOpt_inputs/UL/output_files_Tprime%sVsHiggs_BDTG_UL/Run2/", training[j].c_str());
...
//cout<<procs_[i].c_str()<<" 		& $"<<Form("%0.2f",s)<<"$ \\\\"<<endl;//<<"    "<<s/1892.391<<endl;
		abs_eff[i]= s/(137*xsbr[i]*1000*0.00227);
//cout<<procs_[i].c_str()<<"        & $"<<Form("%0.2f",s)<<"$ \\\\"<<"    "<<s/(137*xsbr[i])<<endl;
cout<<procs_[i].c_str()<<"        "<<Form("%0.3f",s)<<"    "<<Form("%0.3f",(s/(137*xsbr[i]*1000*0.00227)))<<endl;
...
//c2->SaveAs("/eos/user/p/prsaha/www/Tprime_analysis/UL/Eff_AfterOpt_test.png");
//c2->SaveAs("/eos/user/p/prsaha/www/Tprime_analysis/UL/Eff_AfterOpt_test.pdf");
} 
