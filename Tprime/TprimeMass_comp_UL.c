...
*/
file_path = "/eos/user/p/prsaha/Tprime_analysis/MVAOpt_inputs/UL/";//output_files_Tprime600_700VsHiggs_BDTG/Run2";
...
for(i=0; i<file.size(); i++)
	...
	if(procs[i]  == "Tprime_600" || procs[i]  == "Tprime_625" || procs[i]  == "Tprime_650"|| procs[i]  == "Tprime_675" || procs[i]  == "Tprime_700"){
		file_ = new TFile(file_path + "output_files_Tprime" + m_range[0] + "VsHiggs_BDTG_UL/Run2/" + file.at(i), "READ");
//		hist[i] =new TH1F("hist"," ;Tprime_mass", 400, 460, 800);
	}
	else if(procs[i]  == "Tprime_800" || procs[i]  == "Tprime_900" || procs[i]  == "Tprime_1000"){
		file_ = new TFile(file_path + "output_files_Tprime" + m_range[1] + "VsHiggs_BDTG_UL/Run2/" + file.at(i), "READ");
    }
	else if(procs[i]  == "Tprime_1100" || procs[i]  == "Tprime_1200" ){
        file_ = new TFile(file_path + "output_files_Tprime" + m_range[2] + "VsHiggs_BDTG_UL/Run2/" + file.at(i), "READ");
    }
...
c2->SaveAs("/eos/user/p/prsaha/www/Tprime_analysis/UL/TprimeMass_comp.pdf");
c2->SaveAs("/eos/user/p/prsaha/www/Tprime_analysis/UL/TprimeMass_comp.png");
} 
