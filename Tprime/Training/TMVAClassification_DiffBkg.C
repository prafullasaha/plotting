...
int TMVAClassification_DiffBkg( TString myMethodList = "", int year=2 )
{
   ...
   // --------------------------------------------------------------------------------------------------
   TMVA::DataLoader *dataloader=new TMVA::DataLoader(Form("dataset_Run%i_Tprime600_700VsHiggs",year));
...
//   TTree *background     = (TTree*)input1->Get("events_tth");
   ...
   TString outfileName( Form("TMVA_Run%i_Tprime600_700VsHiggs.root", year) );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
