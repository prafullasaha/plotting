...
int TMVAClassification_DiffBkg_ReReco( TString myMethodList = "", int year=2 )
{
   ...
   // --------------------------------------------------------------------------------------------------
   TMVA::DataLoader *dataloader=new TMVA::DataLoader(Form("dataset_Run%i_Tprime800_1000VsHiggs",year));
...
//   TTree *background     = (TTree*)input1->Get("events_tth");
   ...
   TString outfileName( Form("dataset_Run%i_Tprime800_1000VsHiggs/TMVA_Run%i_Tprime800_1000VsHiggs.root", year, year) );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_DiffBkg_ReReco(methodList, year);
}
